      ...
      <div className="relative px-4 ">
        ...
        <div className="mt-8">
          <ul className="grid grid-flow-col gap-4 overflow-x-scroll scrollbar-hide">
            {items.map((item, i) => (
              <li key={i} onClick={() => setActive(i)} className={`flex items-center justify-center w-auto px-6 py-2 whitespace-nowrap  ${active === i && "bg-[#F5E400]"}  rounded-full hover:cursor-pointer hover:bg-yellow-200 hover:text-white border border-gray-600`}>
